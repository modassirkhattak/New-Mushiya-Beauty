  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(children: [_buildBlogList(), _buildPagesList()]),
      ),
    );
  }
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder:
            (_, int index) => ListTile(
              title:
                  articles.articleList[index].title == null
                      ? const Text('No Title')
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) =>
                            ArtilePage(article: articles.articleList[index]),
                  ),
                );
              },
            ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            fit: BoxFit.contain,
                            image: NetworkImage(article.image!.originalSrc),
                          ),
                        ),
                      ),
