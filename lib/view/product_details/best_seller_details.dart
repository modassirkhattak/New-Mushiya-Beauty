...
class BestSellerDetails extends StatefulWidget {
  ...
  @override
  State<BestSellerDetails> createState() => _BestSellerDetailsState();
}

class _BestSellerDetailsState extends State<BestSellerDetails> {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  MaterialButton(
                    onPressed:
                        () => controller.fetchProduct(int.parse(widget.id)),
                    color: redColor,
                    child: const Text(
                      'Retry',
