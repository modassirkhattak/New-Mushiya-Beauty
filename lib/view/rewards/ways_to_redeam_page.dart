...
class WaysToRedeamPage extends StatelessWidget {
  WaysToRedeamPage({super.key});
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: MyAppBarWidget(
          title: "Ways to Redeem".toUpperCase(),
          titleImage: true,
          actions: true,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: LinearGradient(
                        ...
                        colors: [greyColor, Colors.black87.withOpacity(0.1)],
                      ),
                    ),
                    child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(18.0),
                      child: SvgPicture.asset('assets/icons_svg/coupos.svg'),
                    ),
                  ),
                  // SizedBox(height: 10),
                  Column(
