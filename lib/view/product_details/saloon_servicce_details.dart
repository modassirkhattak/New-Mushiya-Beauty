...
class SaloonServiceDetails extends StatefulWidget {
  ...
  final String title;
  final TeethServiceProductModel homeModel;

  @override
  State<SaloonServiceDetails> createState() => _SaloonServiceDetailsState();
}

class _SaloonServiceDetailsState extends State<SaloonServiceDetails> {
