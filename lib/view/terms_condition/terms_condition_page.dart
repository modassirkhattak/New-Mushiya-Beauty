  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: controller.retryTermsAndConditionFetch,
                  child: const Text(
                    'Retry',
        ...
        if (controller.termsAndCondition.value == null) {
          return const Center(child: Text('Terms & Conditions not found'));
        }

        final policy = controller.termsAndCondition.value!;
