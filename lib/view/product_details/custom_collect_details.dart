...
class CustomCollectDetails extends StatefulWidget {
  ...
  final String title;
  final CollectionSubProductModel homeModel;

  @override
  State<CustomCollectDetails> createState() => _CustomCollectDetailsState();
}
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                // Variant dropdown
                if (product.variants.first.option1 != null)
                  CustomDropdown(
                    hintText:
                        'Select ${product.options[0].name}', // e.g., "Select Size"
                    items:
                        product.variants
                    ...
                    onChanged: (value) {
                      ...
                      homeController.selectedVariant.value = selectedVariant;
                ...
                const SizedBox(height: 16),
                // Color dropdown
                if (product.variants.first.option2 != null)
                  CustomDropdown(
                    hintText:
                        'Select ${product.options[1].name}', // e.g., "Select Color"
                    items:
                        product.variants
                ...
                const SizedBox(height: 16),
                // fullOption dropdown
                if (product.variants.first.option3 != null)
                  CustomDropdown(
                    hintText:
                        'Select ${product.options[2].name}', // e.g., "Select Color"
                    items:
                        product.variants
