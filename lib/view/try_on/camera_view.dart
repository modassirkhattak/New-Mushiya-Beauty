  ...
  Widget _detectionViewModeToggle() => Positioned(
    ...
    child: SizedBox(
      ...
      child: FloatingActionButton(
        ...
        child: Icon(Icons.photo_library_outlined, size: 25, color: whiteColor),
      ),
    ),
  );
    ...
    child: SizedBox(
      ...
      child: FloatingActionButton(
        ...
        child: CircleAvatar(
          ...
          child:
              isRecording ? Icon(Icons.stop) : Icon(Icons.camera_alt_outlined),
        ),
      ),
    ),
  );
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Image.asset('assets/wig_try_on.png'),
                  ),
                  CustomText(
                    text: "Baby Naps",
                    fontSize: 14,
        ...
        child: Center(
          child: SizedBox(
            ...
            child: GestureDetector(
                ...
                child: CircleAvatar(child: Image.asset('assets/wig_try_on.png',),backgroundColor: Colors.white,)),
          ),
        ),
      );
